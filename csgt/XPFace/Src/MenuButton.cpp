...
BEGIN_MESSAGE_MAP(CXFMenuButton, CButton)
	//{{AFX_MSG_MAP(CXFMenuButton)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CXFMenuButton message handlers

DWORD CXFMenuButton::DoSingleClick(UINT uiIDMenuResource)
{
    // -[Feral]-----------------------------------------------------------
    // Vars and Assignment
    CMenu menu;

...
// fcampos@tutopia.com.
//
// GuiEdit.cpp : implementation file
//
...
void CGuiEdit::OnNcCalcSize(BOOL bCalcValidRects, NCCALCSIZE_PARAMS FAR* lpncsp) 
{
	// TODO: Add your message handler code here and/or call default
	if (m_bnt.GetSafeHwnd()) 
	{
		CSize msz= m_bnt.GetSizeButton();
		lpncsp->rgrc[0].right -= msz.cx;
	}
...
{
	int numEfect=0;
	for (int i;m_cadResult.GetLength()-1; i++)

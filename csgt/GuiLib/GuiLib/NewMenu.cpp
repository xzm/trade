...
BOOL CMenuThemeXP::OnDrawBorder(HWND hWnd, HDC hDC)
{
  ...
  if(DoDrawBorder() && pData)
  {
    ...
    if(!IsShadowEnabled())
    {
      ...
      pDC->Draw3dRect(CRect(CPoint(0,0),CSize(winW-4,winH-4)),GuiDrawLayer::GetRGBColorShadow(),GuiDrawLayer::GetRGBColorShadow());
    ...
    else
    {
      ...
      pDC->Draw3dRect(CRect(CPoint(0,0),CSize(winW-0,winH-0)),GuiDrawLayer::GetRGBColorShadow(),GuiDrawLayer::GetRGBColorShadow());
    }
	pDC->Draw3dRect(CRect(CPoint(1,1),CSize(1,winH-6)),GuiDrawLayer::GetRGBColorFace(),GuiDrawLayer::GetRGBColorFace());

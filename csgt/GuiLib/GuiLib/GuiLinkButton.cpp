...
CGuiLinkButton::CGuiLinkButton()
{
	...
	m_Link="";
	m_cfont.CreateFont(14,0,0,0,400,0,1,0,0,1,2,1,34,"Arial");
	m_iSelected=0;
...
void CGuiLinkButton::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
	...
	if (SizeCad.cx < m_rect.Width())
	{
		...
		m_iposx=m_rect.Width()-(SizeCad.cx+30);
...
void CGuiLinkButton::SetToolTip(LPCSTR m_lpMsg)
{
...
void CGuiLinkButton::SetLink(LPCSTR lpMsg)
{
	m_Link=lpMsg;
}
...
{
	// TODO: Add your message handler code here and/or call default
	ShellExecute (NULL, "open",m_Link, NULL, NULL, 0) ;

...
void CMenuIcon::TrackPopup(CWnd* pBar, CWnd* pWndSentCmd)
{
	...
	::TrackPopupMenuEx(hSysMenu, fuFlags, pt.x, pt.y,pBar->GetSafeHwnd(), &tpm);
...
CMenuControl::CMenuControl(CWnd* pMenuBar)
{
	...
	m_arrButton[2].SetColor(GuiDrawLayer::GetRGBColorFace());
	...
	m_arrButton[1].SetColor(GuiDrawLayer::GetRGBColorFace());
	...
	m_arrButton[0].SetColor(GuiDrawLayer::GetRGBColorFace());

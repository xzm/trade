...
#include "stkfmt.h"			// 永新卡数据结构定义
#include "stkfilter.h"		// 永新卡数据结构定义
#include "cppstkfilter.h"	// 永新卡数据结构定义
#include "Yongxin.h"		// 永新卡使用函数

...
char self_sh_xdr[]		=	"data\\shase\\xdrdata\\";
char self_sz_xdr[]		=	"data\\sznse\\xdrdata\\";
char self_news[]		=	"data\\news\\";

char self_chna_xdr[]	=	"data\\CHNA.pwr";		// 除权文件，与分析家格式相同
char self_chna_basetbl[]=	"data\\CHNA.bst";		// 财务资料表
...
// 行情缓存文件
char self_sh_report[]	=	"dat\\SHSE.rpt";		// 上海行情保存文件
char self_sz_report[]	=	"dat\\SZSE.rpt";		// 深圳行情保存文件
char self_sh_minute[]	=	"dat\\SHSE.min";		// 上海分时保存文件
char self_sz_minute[]	=	"dat\\SZSE.min";		// 深圳分时保存文件
char self_outline[]		=	"dat\\clkoutln.out";

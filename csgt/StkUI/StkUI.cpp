...
/////////////////////////////////////////////////////////////////////////////
// The one and only CStkUIApp object
...
/*
	...
	splash.Create( NULL, 0, AfxGetSView().GetU( ), AfxGetSView().GetS( ),
				AfxGetVersionString( ), FALSE, 0, STKLIB_MAX_PROGRESS );
...
*/
	...
	AfxGetStkReceiver().EngineBeginWorking(FALSE);	// 启动通视接收系统，不显示选择接收系统对话框
...
//		return FALSE;
	...
	// Check Evalation
	m_pMainWnd->SetTimer( TIMER_CHECKVALID, 1000, NULL );
	m_pMainWnd->SetTimer( TIMER_SHOWNETINFO, 1000, NULL );

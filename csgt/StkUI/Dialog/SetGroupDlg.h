...
/***
	显示板块或分组的ComboBox
*/
class CDomainComboBox : public CGuiComboBoxExt
{
// Construction
public:
	CDomainComboBox();
...
// Dialog Data
	...
	CGuiButton	m_btnRemoveAll;
	CGuiButton	m_btnRemoveSelected;
	CGuiButton	m_btnAddAll;
	CGuiButton	m_btnAddSelected;
	CGuiButton	m_btnDeleteGroup;
	CGuiButton	m_btnAddGroup;

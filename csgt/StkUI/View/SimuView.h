...
public:
	...
	CGuiButton	m_btnAdvanced;
	CEdit	m_editStockTech;
	CGuiComboBoxExt	m_comboSellLogic;
	CGuiComboBoxExt	m_comboBuyLogic;
	CGuiButton	m_btnStop;
	CEdit	m_editStartAmount;
	CStatic		m_staticYield2;
	CStatic		m_staticYield;
	CDateTimeCtrl	m_tmctrlBegin;
	CDateTimeCtrl	m_tmctrlEnd;
	CGuiComboBoxExt	m_comboStoreDiv;
	CIntensityComboBox	m_comboSellLimit;
	CEdit		m_editBuyMulti;
	CIntensityComboBox	m_comboBuyLimit;
	CGuiComboBoxExt	m_comboMaindataType;
	CStatic		m_staticWarning;
	CStatic		m_staticTitle;
	CGuiButton	m_btnRealOp;
	CGuiButton	m_btnSetRule;
	CGuiButton	m_btnSetRate;
	CGuiButton	m_btnSetPrpt;
	CGuiButton	m_btnReport;
	CGuiButton	m_btnSelectStk;

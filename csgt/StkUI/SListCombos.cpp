...
BOOL CDateComboBox::PreTranslateMessage(MSG* pMsg)
{
	...
	return CGuiComboBoxExt::PreTranslateMessage(pMsg);
}

BEGIN_MESSAGE_MAP(CDateComboBox, CGuiComboBoxExt)
...
BEGIN_MESSAGE_MAP(CSearchBox, CGuiComboBoxExt)
